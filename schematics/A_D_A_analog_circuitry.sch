...
C {devices/lab_pin.sym} -1100 10 1 0 {name=p41 sig_type=std_logic lab=VDD}
...
C {devices/lab_pin.sym} -890 60 1 0 {name=p44 sig_type=std_logic lab=STO-b_RCL+b}
...
value="pulse(0 1.8 1000n 200n 200n 400n 1500n)"}
